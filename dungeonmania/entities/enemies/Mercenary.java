...
public class Mercenary extends Enemy implements Interactable {
    ...
    public Mercenary(Position position, double health, double attack, int bribeAmount, int bribeRadius,
        ...
        // set strategy
        setMoveStrategy(new AdjacentMovementStrategy());
    }
    ...
    public void move(Game game) {
        ...
        if (allied) {
            ...
            // Move randomly using RandomMovementStrategy class
            ...
            // Move adjacent using AdjacentMovementStrategy class
            MoveStrategy movementStrategy = new AdjacentMovementStrategy();
            nextPos = movementStrategy.getNextPosition(this, game);
        } else {
            // Follow hostile using default strategy (dijkstraPathFind)
